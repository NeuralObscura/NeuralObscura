...
class NeuralStyleModel {
    ...
    let c1, c2, c3: BatchNormalizationLayer
    let r1, r2, r3, r4, r5: ResidualBlock
    let d1, d2: BatchNormalizationLayer
    let d3: DeconvolutionLayer
